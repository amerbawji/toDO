        ...
        <div className={styles['Content-container6']}>
          ...
          <div className={styles['Locations-container']}>
            <div className={styles['Location-1']}>
              <span className={styles['Heading09']}>Lebanon, Beirut</span>
              <div className={styles['Adress']}>
                <svg viewBox="0 0 1024 1024" className={styles['icon54']}>
                  <path d="M512 0c-176.732 0-320 143.268-320 320 0 320 320 704 320 704s320-384 320-704c0-176.732-143.27-320-320-320zM512 512c-106.040 0-192-85.96-192-192s85.96-192 192-192 192 85.96 192 192-85.96 192-192 192z"></path>
                </svg>
                <span className={projectStyles['section-Text']}>Dbaye</span>
              </div>
              ...
              <div className={styles['Phone']}>
                ...
                <span className={projectStyles['section-Text']}>76730370</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={styles['Footer-container']}>
        <div className={styles['Footer']}>
          ...
          <div className={styles['Copyright-container']}>
            ...
            <span className={projectStyles['anchor']}>Copyright, 2022</span>
          </div>
        </div>
      </div>
    </div>
